...
export function loadHome() {
  ...
  const menuCard = homeGrid.newCard("Dine-in, Pick-up & Delivery", "", boxesCard, "Max Avans", "https://www.pexels.com/photo/person-slicing-the-pizzas-5056849/");
  menuCard.scale(0, 2);
  homeGrid.newCard("Daily Specials", "", ovenCard, "Eneida Nieves", "https://www.pexels.com/photo/baked-pizza-on-pizza-peel-in-oven-905847/");
  homeGrid.newCard("Fresh Ingredients", "", tomatoCard, "Abdul Kadher Akib", "https://www.pexels.com/photo/close-up-photo-of-red-tomatoes-11463629/");
}
